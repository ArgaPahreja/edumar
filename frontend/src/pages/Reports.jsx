...
const Reports = (CUId) => {
  // State untuk menyimpan data pengguna, status loading, dan data ujian
  const [userDatas, setUserDatas] = useState([]);
  const [isLoading, setIsLoading] = useState(true);
  const [examDatas, setExamDatas] = useState([]);

  // Hook useEffect untuk mendapatkan data pengguna dan data ujian saat komponen dimuat
  useEffect(() => {
    getUserDatas();
    getExamDatas();
  }, []);
  ...
  console.log();
  // Jika sedang dalam proses loading, tampilkan loading spinner
  if (isLoading) {
    return (
      <>
        <LoginNavbar />
